...
// http://sourceforge.net/tracker/import.php?func=detail&aid=1466964&group_id=99160&atid=623334
	...
	private function _readHyperLink()
	{
		...
		if (!$this->_readDataOnly) {
			...
			case 'URL':
				...
				// e.g. http://example.org/import.php
...
//			var_dump($bcBitCount);
	...
	public static function _GetInt4d($data, $pos)
	{
		...
		// http://sourceforge.net/tracker/import.php?func=detail&aid=1487372&group_id=99160&atid=623334
